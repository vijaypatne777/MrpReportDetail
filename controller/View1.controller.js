	...
	return t.extend("YY1_MAT_CONSUME_UI5.Material_Consume_13.controller.View1", {
						...
						for (var p = 0; p < e.GOODS_MVMT_CUM.length; p++) {
							if (e.MatStock[r].Material === e.GOODS_MVMT_CUM[p].Material && e.MatStock[r].Plant === e.GOODS_MVMT_CUM[p].Plant) {
								...
								if ((e.GOODS_MVMT_CUM[p].Plant === "US01" || e.GOODS_MVMT_CUM[p].Plant === "US02" || e.GOODS_MVMT_CUM[p].Plant === "US03") &&
									...
									// a.GoodsShipped = parseFloat(e.GOODS_MVMT_CUM[p].TotalGdsMvtQtyInBaseUnit);
									...
									for (var x = 0; x < e.GOODS_MVMT_CUM.length; x++) {
										if (e.GOODS_MVMT_CUM[x].Material === e.GOODS_MVMT_CUM[p].Material &&
											...
											// if (e.GOODS_MVMT_CUM[p].GoodsMovementType === "601") {
										...
										if (e.GOODS_MVMT_CUM[x].Material === e.GOODS_MVMT_CUM[p].Material &&
											...
											// if (e.GOODS_MVMT_CUM[p].GoodsMovementType === "602") {
								...
								if ((e.GOODS_MVMT_CUM[p].Plant === "US01" || e.GOODS_MVMT_CUM[p].Plant === "US02" || e.GOODS_MVMT_CUM[p].Plant === "US03") &&
									...
									// if (e.GOODS_MVMT_CUM[p].GoodsMovementType === "201") {
									// 	a.Consumption201 = parseFloat(e.GOODS_MVMT_CUM[p].TotalGdsMvtQtyInBaseUnit);
									// }
									// if (e.GOODS_MVMT_CUM[p].GoodsMovementType === "202") {
									// 	a.Consumption202 = parseFloat(e.GOODS_MVMT_CUM[p].TotalGdsMvtQtyInBaseUnit);
									// }
									...
									// a.Consumption = parseFloat(e.GOODS_MVMT_CUM[p].TotalGdsMvtQtyInBaseUnit);
								}
								if (t <= 24) {
		...
		onDataExport: function (e) {
			...
			var a = new p({
				...
				// {
				// 	name: "Goods Shipped601",
				// 	template: {
				// 		content: "{GoodsShipped601}"
				// 	}
				// }, {
				// 	name: "Goods Shipped601",
				// 	template: {
				// 		content: "{GoodsShipped602}"
				// 	}
				// }, 
				{
					name: "Goods Shipped",
				...
				// 	template: {
				// 		content: "{Consumption201}"
				// 	}
				// }, {
				// 	name: "Goods Consumption",
				// 	template: {
				// 		content: "{Consumption202}"
				// 	}
				// }, 
				{
					name: "Consumption",
